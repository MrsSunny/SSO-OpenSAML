...
public class RoleDao {
  ...
  public List<Role> getRole(String query, String order, int startIndex, int size) {
    ...
    List<Role> list = sysJdbcTemplate.querySP(sql, startIndex, size);
    return list;
  }
  ...
  public int update(Role role) {
    ...
    Object[] params = new Object[] { role.getName(), role.getDescription(), role.getUsable_status(),role.getModify_date(), role.getModify_user_id(), role.getId() };
  ...
  public Role findById(long id) {
    ...
    sysJdbcTemplate.query("SELECT ID, NAME, CREATE_DATE,DESCRIPTION FROM ROLE WHERE id = ?", new Object[] { id }, new RowCallbackHandler() {
      public void processRow(ResultSet rs) throws SQLException {
        ...
        role.setCreate_date(rs.getTimestamp("create_date"));
