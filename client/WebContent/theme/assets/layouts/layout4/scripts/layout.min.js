var Layout = function() {
	...
	o = function() {
		...
		if (t.hasClass("page-footer-fixed") === !0 && t.hasClass("page-sidebar-fixed") === !1) {
			...
			if (t.hasClass("page-sidebar-fixed")) e = l(),
			t.hasClass("page-footer-fixed") === !1 && (e -= $(".page-footer").outerHeight());
			else {
				var n = $(".page-header").outerHeight(),
				d = $(".page-footer").outerHeight();
				e = App.getViewPort().width < s ? App.getViewPort().height - n - d: i.height() + 20,
				e + n + d <= App.getViewPort().height && (e = App.getViewPort().height - n - d)
			}
			a.css("min-height", e)
		}
	},
	...
	n = function() {
		...
		function(e) {
			if (! (App.getViewPort().width >= s && 1 === $(this).parents(".page-sidebar-menu-hover-submenu").size())) {
				...
				var p = -200;
				r.is(":visible") ? ($(".arrow", $(this)).removeClass("open"), $(this).parent().removeClass("open"), r.slideUp(l,
				function() {
					n === !0 && $("body").hasClass("page-sidebar-closed") === !1 && ($("body").hasClass("page-sidebar-fixed") ? t.slimScroll({
						scrollTo: i.position().top
					}) : App.scrollTo(i, p)),
					o()
				})) : ($(".arrow", $(this)).addClass("open"), $(this).parent().addClass("open"), r.slideDown(l,
				function() {
					n === !0 && $("body").hasClass("page-sidebar-closed") === !1 && ($("body").hasClass("page-sidebar-fixed") ? t.slimScroll({
						scrollTo: i.position().top
					}) : App.scrollTo(i, p)),
	...
	d = function() {
		...
		o(),
		0 !== $(".page-sidebar-fixed").size() && App.getViewPort().width >= s && !$("body").hasClass("page-sidebar-menu-not-fixed") && (e.attr("data-height", l()), App.destroySlimScroll(e), App.initSlimScroll(e), o())
	},
	p = function() {
		var e = $("body");
	...
	c = function() {
		...
		function(a) {
			...
			e.hasClass("page-sidebar-closed") ? (e.removeClass("page-sidebar-closed"), i.removeClass("page-sidebar-menu-closed"), Cookies && Cookies.set("sidebar_closed", "0")) : (e.addClass("page-sidebar-closed"), i.addClass("page-sidebar-menu-closed"), e.hasClass("page-sidebar-fixed") && i.trigger("mouseleave"), Cookies && Cookies.set("sidebar_closed", "1")),
		...
		loadAjaxContent: function(e, a) {
			...
			$.ajax({
				...
				error: function(e, a, o) {
					...
					for (var r = 0; r < t.length; r++) i[r].call(e)
				}
			})
		},
